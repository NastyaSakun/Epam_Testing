...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        [Test]
        public void HasMilitaryTransportPlaneIsTrue()
        {            
            Assert.IsTrue(airport.HasMilitaryTransportPlane());
        }

        [Test]
        public void MaxPassengerCapacityAreEqual()
        {      
            Assert.AreEqual(airport.GetPassengerPlaneWithMaxPassengersCapacity(), planeWithMaxPassengerCapacity);
        }

        [Test]
        public void SortByMaxLoadCapacityIsTrue()
        {

            Assert.IsTrue(airport.IsSortMaxLoadCapacityPlaneCorrect());
        }
    }
}
